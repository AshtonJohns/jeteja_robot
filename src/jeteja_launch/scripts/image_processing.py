...
ADJUSTED_MOTOR_MAX_DUTY_CYCLE = master_config.ADJUSTED_MOTOR_MAX_DUTY_CYCLE
ADJUSTED_MOTOR_MIN_DUTY_CYCLE = master_config.ADJUSTED_MOTOR_MIN_DUTY_CYCLE
ADJUSTED_STEERING_MAX_DUTY_CYCLE = master_config.ADJUSTED_STEERING_MAX_DUTY_CYCLE
ADJUSTED_STEERING_MIN_DUTY_CYCLE = master_config.ADJUSTED_STEERING_MIN_DUTY_CYCLE
...
def normalize_pwm(motor_pwm, steering_pwm):
    """Normalize PWM values to [0, 1]"""
    motor_pwm_normalized = (motor_pwm - ADJUSTED_MOTOR_MIN_DUTY_CYCLE) / MOTOR_PWM_NORMALIZATION_FACTOR
    steering_pwm_normalized = (steering_pwm - ADJUSTED_STEERING_MIN_DUTY_CYCLE) / STEERING_PWM_NORMALIZATION_FACTOR
    return motor_pwm_normalized, steering_pwm_normalized
