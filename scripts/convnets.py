...
class DonkeyNet(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        # Change input channels of conv24 from 3 to 4 to accommodate RGB + depth
        ...
        # Update fc1 with the new input size if needed based on input image dimensions
        self.fc1 = nn.Linear(64 * 33 * 23, 128)
